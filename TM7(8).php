...
<body>
        ...
        <div class="card" style="width: 400px">
            ...
            <div class="card-body bg-warning">
                <form action="#">
                    ...
                    <div class="col-6 mb-3">
                        <label>Jumlah Transaksi Maxim:</label>
                        <input class="form-control" type="text" name="jumlah_maxim" value="<?= htmlspecialchars($data['jumlah_maxim']) ?>" readonly>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center" style="height: 300px">
        <div class="card" style="width: 400px">
            ...
            <div class="card-body warna-kuning">
                <form action="TM7(9).php" method="post">
                    <div class="col-6 mb-3">
                        <label>Tanggal:</label>
                        <input class="form-control" type="text" name="tanggal" value="<?= htmlspecialchars($data['tanggal']) ?>" readonly>
                    </div>
                    <div class="col-6 mb-3">
                        <label>Jumlah Transaksi Maxim:</label>
                        <input class="form-control" type="text" name="jumlah_maxim" value="<?= htmlspecialchars($data['jumlah_maxim']) ?>">
                    </div>
