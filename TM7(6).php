...
<body>
        ...
        <div class="card" style="width: 400px">
            ...
            <div class="card-body bg-primary text-white">
                <form action="#">
                    ...
                    <div class="col-6 mb-3">
                        <label>Jumlah Transaksi Grab:</label>
                        <input class="form-control" type="text" name="jumlah_grab" value="<?= htmlspecialchars($data['jumlah_grab']) ?>" readonly>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center" style="height: 300px">
        <div class="card" style="width: 400px">
            ...
            <div class="card-body warna-biru">
                <form action="TM7(7).php" method="post">
                    <div class="col-6 mb-3">
                        <label>Tanggal:</label>
                        <input class="form-control" type="text" name="tanggal" value="<?= htmlspecialchars($data['tanggal']) ?>" readonly>
                    </div>
                    <div class="col-6 mb-3">
                        <label>Jumlah Transaksi Grab:</label>
                        <input class="form-control" type="text" name="jumlah_grab" value="<?= htmlspecialchars($data['jumlah_grab']) ?>">
                    </div>
